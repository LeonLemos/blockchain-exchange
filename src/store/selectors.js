...
export const myOpenOrdersSelector = createSelector(
    ...
    (account, tokens, orders) => {
        ...
        //If theres no tokens, dont do anything.
...
const decorateOrder = ( order, tokens ) => {
    ...
    //Note : Dapp shoulbe considered token0, mETH is considered token1
...
export const myFilledOrdersSelector = createSelector(
    ...
    (account, tokens, orders) => {
        ...
        //Filter for current trading pair
        orders = orders.filter((o) => o.tokenGet === tokens[0].address || o.tokenGet === tokens[1].address)
        orders = orders.filter((o) => o.tokenGive === tokens[0].address || o.tokenGive === tokens[1].address) 
...
export const priceChartSelector = createSelector(
    ...
    //Sort ordesr by date ascending to compare history
    orders = orders.sort((a,b) => a.timestamp - b.timestamp)
...
const buildGraphData = (orders) => {
    ...
    const graphData = hours.map((hour) => {
        ...
        //Fetch all ordersf rom current hour
        ...
        const close = group[group.length -1] //last price
